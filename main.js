...
document.querySelector("#inventoryTable tbody").addEventListener("focusout", async (e)=>{
    ...
    if((col==="tag"||col==="serial")&&!newValue){
        alert("Asset Tag and Serial cannot be empty."); renderTable(); return;
    }
...
reportBtn.addEventListener("click", ()=>{
    ...
    const reportHTML=`<html><head><title>Inventory Report</title><style>body{font-family:Arial;padding:20px;}h1{text-align:center;color:#0056b3;}table{width:100%;border-collapse:collapse;margin-top:20px}th,td{border:
